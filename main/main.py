...
from style import set_primary_color
from layout import (
...
def create_presentation_from_json(json_data):
    ...
    for slide_data in json_data:
        ...
        elif layout == "content_with_caption":
...
def main():
    ...
    # 💬 Move input inside main
    print("Available colors: Blue, Red, Green, Yellow, Orange, Purple, Gray")
    user_color = input("Enter your desired color: ").strip()
    set_primary_color(user_color)
